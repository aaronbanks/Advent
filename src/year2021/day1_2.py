...
def window_comparison():
    ...
    if current_completed_window == 1:
        print(
            f"The three numbers in the previous window were: {window_6} and the three in the current window are: {window_1}"
        )
        print(
        ...
        print(
            f"The three numbers in the previous window were: {window_1} and the three in the current window are: {window_2}"
        )
        print(
        ...
        print(
            f"The three numbers in the previous window were: {window_2} and the three in the current window are: {window_3}"
        )
        print(
        ...
        print(
            f"The three numbers in the previous window were: {window_3} and the three in the current window are: {window_4}"
        )
        print(
        ...
        print(
            f"The three numbers in the previous window were: {window_4} and the three in the current window are: {window_5}"
        )
        print(
        ...
        print(
            f"The three numbers in the previous window were: {window_5} and the three in the current window are: {window_6}"
        )
        print(
