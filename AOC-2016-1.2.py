def main():
    ...
    with open('input201601.txt', 'r') as input:
        ...
        for line in input:
                ...
                for instruction in current_line_contents:
                    ...
                    current_compass_direction = list_of_compass_directions[compass_direction_value]
                    ...
                    while counter <= int(instruction[1:]):
                        ...
                        if current_location in set_of_locations_visited:
                            ...
                            print(f"The locations visited so far: {set_of_locations_visited}")
    ...
    distance_to_destination = abs(first_location_visited_twice[0]) + abs(first_location_visited_twice[1])
